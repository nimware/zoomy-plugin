					...
					var image = (typeof (ele.attr(options.attr)) === 'string' && options.attr !== 'href') ?  ele.attr(options.attr) : ele.attr('href'),
						...
						eventHandler = function () {
							...
							if(touch){
								...
								var thisBtn = $('.zoomy-btn-' + i);
							
								thisBtn.bind('touchstart', function(){
								
									$(this).parent('div').addClass('active');

									ele.bind(eventlist);
									ele.trigger('touchmove');
						...
						button = (touch) ? ['<div class="zoomy-wrap" />', '<div class=" zoomy-btn zoomy-btn-' + i + '"><div></div></div>'] : ['', ''];
